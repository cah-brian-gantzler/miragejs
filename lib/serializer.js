  ...
  */
  ...
  resolveTransforms(model) {
    ...
    Object.keys(model.attrs).forEach(item => {
      ...
      this.setTransformDefaults(transform, item, this.attrs, fks);
    });
  }
  ...
  setTransformDefaults(transform, property, whitelist, fks) {
